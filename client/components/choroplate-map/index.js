...
export default class ChoroplateMap extends Component {

    renderMap() {
        const width = 800,
              height = 550;
        let projection = d3.geo.mercator().scale(100)
        let svg = d3.select("#choroplate-map").append("svg").attr("width", width).attr("height", height);
